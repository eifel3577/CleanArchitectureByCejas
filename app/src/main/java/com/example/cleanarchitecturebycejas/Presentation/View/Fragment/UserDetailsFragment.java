...
import com.example.cleanarchitecturebycejas.Presentation.Presenter.UserDetailsPresenter;
import com.example.cleanarchitecturebycejas.Presentation.View.Component.AutoLoadImageView;
...
/**
 * фрагмент который показывает детальную информацию по пользователю
 */
